"""ISO 3166-1 alpha-2 country codes accepted for users.country (the Register
form's Country field -- GDPR Phase 3, used later for region-specific notices
such as UK / India). Keep in sync with apps/dashboard/src/shared/countries.ts.
"""
